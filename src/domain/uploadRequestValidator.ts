import { UploadRequestQuery, UploadValidationResult } from './models/uploadTicket.interface';
...
export default class UploadRequestValidator {
    public static validate(query: UploadRequestQuery | undefined | null): UploadValidationResult {
        const errors: string[] = [];
